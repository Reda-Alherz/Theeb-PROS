...
// https://ez-robotics.github.i=0000o/EZ-Template/
/////

// Chassis constructor
ez::Drive chassis(
    // These are your drive motors, the first motor is used for sensing!
    {-11, -12, -14, -16},     // Left Chassis Ports (negative port will reverse it!)
    {19, 18, 17, 13},  // Right Chassis Ports (negative port will reverse it!)

    3,      // IMU Port
    3.25,  // Wheel Diameter (Remember, 4" wheels without screw holes are actually 4.125!)
    360);   // Wheel RMP = cartridge * (motor gear / wheel gear)
...
void initialize() {
  ...
  ez::as::auton_selector.autons_add({
      ...
      {"Simple Odom\n\nThis is the same as the drJmive example, but it uses odom instead!", odom_drive_example},
